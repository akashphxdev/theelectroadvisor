...
export default function AuthorsPage() {
  ...
  const [form, setForm] = useState({ name: "", bio: "", is_active: true });
  ...
  const openEdit = (a) => {
    setForm({ name: a.name, bio: a.bio || "", is_active: a.is_active === 1 });
    setEditingId(a.id);
    setError("");
    setModal("edit");
  };
  ...
  const avatarColors = ["#3b82f6", "#8b5cf6", "#10b981", "#f59e0b", "#ef4444", "#6366f1", "#ec4899", "#f97316"];
